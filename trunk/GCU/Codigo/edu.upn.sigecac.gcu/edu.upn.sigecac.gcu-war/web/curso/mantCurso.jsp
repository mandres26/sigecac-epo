...
<div>
    <a4j:outputPanel id="out1" layout="block" >
        <rich:modalPanel id="panel" height="500" autosized="true" >
            <f:facet name="header">
                <h:panelGroup>
            ...
            <div style="height:500px;overflow:auto">
                ...
                <h:form id="frmNuevoCursos">
                    <h:panelGrid columns="2" >
                        ...
                        <h:panelGroup />
                        <h:panelGroup>
                            <a4j:commandButton value="Guardar" id="CGuardar"  action="#{Curso.crearCurso}" reRender="out2" rendered="#{!Curso.cursoRegistrado}"  />
                            <a4j:commandButton value="Actualizar" id="CEditar" action="#{Curso.editarCurso}" reRender="out2" rendered="#{Curso.cursoRegistrado}" />
            ...
            <div style="height:300px;overflow:auto">
                <h:form id="frmNuevoPreReq">
                    <table>
                        ...
                        <tr>
                            <td><a4j:commandButton value="Guardar" id="PreReqGuardar"  action="#{Prerequisito.crearPrerequisito}" reRender="pPreReq"  /></td>
                            <td><h:commandButton value="Cancelar" onclick="#{rich:component('panel2')}.hide()" /></td>
                        </tr>
                    </table>
            </h:form></div>
            <br/>
            ...
            <div style="height:300px;overflow:auto">
                <h:form id="frmNuevoEqui">
                    <table>
                        ...
                        <tr>
                            <td><a4j:commandButton value="Guardar" id="EquiGuardar"  action="#{Equivalencia.crearEquivalencia}" reRender="pEqui"  /></td>
                            <td><h:commandButton value="Cancelar" onclick="#{rich:component('panel3')}.hide()" /></td>
                        </tr>
                    </table>
            </h:form></div>
            <br/>
    ...
    <div style="height:300px;overflow:auto">
        ...
        <h:panelGrid columns="2" >
            ...
            <h:panelGroup />
            <h:panelGroup>
                <a4j:commandButton value="Guardar" id="EdicionGuardar"  action="#{EdicionCurso.crearEdicionCurso}" reRender="pEdiciones"  />
                <a4j:commandButton value="Actualizar" id="EdicionEditar" action="#{EdicionCurso.editarEdicionCurso}" reRender="pEdiciones"  />
    ...
    <table cellpadding="0" cellspacing="0" width="100%" >
        ...
        <tr>
            <td height="25px" >
            <h:form>
                <a4j:commandLink value="Nuevo Curso" action="#{Curso.nuevaCurso}" style="margin-left:20px;" styleClass="lnk n_curso"  oncomplete="#{rich:component('panel')}.show();return false" reRender="out1" />
            </h:form>
            </td>
        </tr>
        <tr>
                ...
                <h:form>
                    <a4j:outputPanel id="out2" layout="block" >
                        <rich:dataTable styleClass="tableGCU"  value="#{Curso.listaCursos}" var="item" rows="20" reRender="ds" id="simpletable">
                            ...
                            <rich:column >
                                <a4j:commandButton value="Seleccionar" reRender="txtNombreCurso,pEdiciones,pPreReq" >
...
<h:form>
    <table cellpadding="0" cellspacing="0" >
        <tr>
            <td align="left" >curso:  <b><h:outputText id="txtNombreCurso" value="#{Curso.curso.nombre}" /></b></td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="left" >
                <rich:tabPanel id="Tab1"  rendered="true" selectedTab="PreReq" width="670px" >
                    <rich:tab id="PreReq" label="Pre Requisitos">
                        <h:form>
                            <a4j:commandLink value="Nuevo PreRequisito" action="#{Prerequisito.nuevaPrerequisito}"  oncomplete="#{rich:component('panel2')}.show();return false" reRender="panelPreReq" />
                        </h:form>
                    ...
                    <rich:tab id="Equiva" label="Equivalencias">
                        <h:form>
                            <a4j:commandLink value="Nueva Equivalencia" action="#{Equivalencia.nuevaEquivalencia}"  oncomplete="#{rich:component('panel3')}.show();return false" reRender="panelEqui" />
                        </h:form>
                    ...
                    <rich:tab id="EdCurso" label="Edicion Curso">
                        <h:form>
                            <a4j:commandLink value="Nueva Edicion" action="#{EdicionCurso.nuevaEdicionCurso}"  oncomplete="#{rich:component('panel4')}.show();return false" reRender="panelEdicion" >
