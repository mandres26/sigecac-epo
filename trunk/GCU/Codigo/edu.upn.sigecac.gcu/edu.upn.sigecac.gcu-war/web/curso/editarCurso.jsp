...
<f:view>
    ...
    <div class="centrar">
        <h1>Editar Curso</h1>
        <h:messages/>
        <h:form id="frmEdicionCurso1" prependId="false">
             
            <h:panelGrid columns="2" >            
                <h:outputLabel value="Codigo Curso"/>
                <h:inputText id="txtCodigo" value="#{Curso.curso.codigo}" />
                <h:outputLabel value="Nombre"/>
                <h:inputText id="txtNombre" value="#{Curso.curso.nombre}" >
                    <f:validateLength
                        maximum="45"
                        minimum="5"/>
                    <f:validator
                ...
                <h:inputText id="txtAbreviatura" value="#{Curso.curso.abreviatura}" >
                    <f:validateLength
                        maximum="8"
                        minimum="2"/>
                    <f:validator
                ...
                <h:inputTextarea id="textDescripcion"  rows="10" cols="30" value="#{Curso.curso.descripcion}">
                    <f:validateLength
                        maximum="59"
                        minimum="10"/>
                    <f:validator
             ...
             <h:outputLabel value="Creditos"/>
                ...
                <h:selectOneMenu  value="#{Curso.curso.fxSubarea.idSubArea}">
                    <f:selectItems value="#{Curso.listaSubAreas}" />
                </h:selectOneMenu>

                .          <h:panelGroup />
                <h:panelGroup>
                    <h:commandButton id="btnGuardar" action="#{Curso.editarCurso}" value="Actualizar" />
