...
<f:view>
    ...
    <BR>
    <div class="centrar">
        <span class="titulo"><h:outputText value="Listar Empleadores" /></span>
        <BR>
        <BR>
        <BR>
        ...
        <center>
            ...
            <h:form id="frmListaEmpleadores">

                <h:panelGrid columns="2" cellpadding="1" cellspacing="10" >
                    <h:commandLink id="btnNuevo" value="Nuevo" accesskey="N" action="#{EmpleadorController.nuevo}"/>
                </h:panelGrid>

                <h:dataTable id="tblEmpleadores"
                             value="#{EmpleadorController.empleadores}"
                             var="item"
                             border="1"
                    ...
                    <h:column>
                        ...
                        <h:outputText value="#{item.idEmpleador}" />
                    </h:column>
                    <h:column>
                        <f:facet name="header"><h:outputText value="Razón Social" /></f:facet>
