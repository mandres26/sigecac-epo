...
<f:view>
    ...
    <h:form>
        ...
        <t:dataTable id="tblCliente"
            ...
            <h:column>
                <f:facet name="header"><h:outputText value="Ver Publicaciones" /></f:facet>
                <h:commandButton styleClass="commandButton_Main" id="btnVerPublicaciones" value="Ver Publicaciones" action="#{Evaluacion.irASeleccionarPeticion}">
                    <f:setPropertyActionListener target="#{Evaluacion.peticionSeleccionada}" value="#{item}" />
                </h:commandButton>
            </h:column>
