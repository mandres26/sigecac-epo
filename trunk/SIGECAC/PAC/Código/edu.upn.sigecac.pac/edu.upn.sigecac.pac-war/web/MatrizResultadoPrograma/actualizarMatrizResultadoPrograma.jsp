...
<f:view>
    ...
    <span class="titulo"><h:outputText style= "margin-left:20px" value="Actualizar Matriz de Alineamiento de Resultados del Programa" /></span>
        ...
        <h:form>
         <fieldset style="width: 93%; margin-left:auto; margin-right:auto">
          <h:panelGrid columns="2" width="91%">
              <h:commandButton style="font-weight: bold; margin-left:120px; margin-right: auto; background:navy; color:white" id="btnGuardar" value="Guardar" accesskey="G" action="#{MatrizAlineamientoResultadosProgramaController.actualizar}" />
         ...
         <br/>
            ...
            <h:panelGrid columns="2" styleClass="formulario" cellpadding="10" cellspacing="0" border="0">
                ...
                <h:inputText styleClass="inputText" id="txtCodigo" value="#{MatrizAlineamientoResultadosProgramaController.matrizAlineamientoResultadosPrograma.idMatrizResultadosPrograma}" readonly="true"/>

                <h:outputLabel styleClass="outputLabel" id="lblNombre" for="txtNombre" value="Nombre: " />
                <h:inputText styleClass="inputText" id="txtNombre" value="#{MatrizAlineamientoResultadosProgramaController.matrizAlineamientoResultadosPrograma.nombre}" >
                ...
                <h:inputTextarea styleClass="inputTextarea" id = "itaDescripcion" value="#{MatrizAlineamientoResultadosProgramaController.matrizAlineamientoResultadosPrograma.descripcion}" cols="50">
