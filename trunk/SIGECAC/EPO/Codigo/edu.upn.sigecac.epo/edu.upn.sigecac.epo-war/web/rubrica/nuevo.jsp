...
<f:view>
    ...
    <h:form>
        <h:panelGrid columns="1" styleClass="formulario" cellpadding="10" cellspacing="0" border="0">
            <h:panelGrid columns="3" styleClass="no-border" cellpadding="10" cellspacing="0" border="0">
                <h:panelGroup>
                ...
                <h:commandButton styleClass="commandButton" id="btnAgregarCriterio" value="Agregar Criterio" action="#{Rubrica.nuevoCE}"/>
            </h:panelGrid>
