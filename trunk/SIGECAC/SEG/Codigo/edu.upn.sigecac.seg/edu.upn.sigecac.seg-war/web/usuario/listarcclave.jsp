...
<f:view>
    ...
    <br/>
    <div class="centrar"><h1><h:outputText value="Listado Claves de Usuarios" /></h1></div>
    <br/>
    <div class="centrar">
        <h:form id="frmListarUsuario" prependId="false">
            ...
            cellspacing="2" rows="15" align="center">
                ...
                <t:column>
                    <f:facet name="header">
                        <t:outputText value="Modificar clave"/>
                    </f:facet>
                    <t:commandLink action="#{UsuarioController.editarclave}">
