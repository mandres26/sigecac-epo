...
<div class="centrar">
    ...
    <h1>Registrar Nueva Edicion de Curso</h1>
    <h:messages/>
    <h:form id="frmNuevaEdicion" prependId="false">
    <h:panelGrid columns="2" >
        <h:outputLabel value="Cursos"/>
        <h:selectOneMenu id="cmbArea" value="#{EdicionCurso.curso.idCurso}">
        ...
        <h:panelGroup />
        <h:panelGroup>
            <h:commandButton id="btnGuardar" action="#{EdicionCurso.crearEdicionCurso}" value="Guardar" />
