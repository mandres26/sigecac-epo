<%-- 
    Document   : nuevoArea
    Created on : 12/04/2009, 05:24:25 PM
    Author     : supervisor
--%>
              ...
              <table cellpadding="0" cellspacing="0" width="100%" >
                ...
                <tr><td height="20px" colspan="2" ></td></tr>
                 ...
                 <tr>
                     ...
                     <td>  <h:selectOneMenu id="cmbNivelProfesional" value="#{Area.nivelProfesional.idNivelProfesional}" required="true" requiredMessage="Seleccione Nivel Profesioanl" >
                 ...
                 <tr>
                     <td></td>
                     <td> <h:commandButton id="btnGuardar" action="#{Area.registrarArea}" value="Guardar" />
