...
<f:view>
    ...
    <BR>
    <div class="centrar">
        <span class="titulo"><h:outputText value="Mostrar Alumno" /></span>
        <BR>
        <BR>
        <BR>
        ...
        <center>
            ...
            <h:form id="idFormulario">
                ...
                <h:panelGrid columns="2">
                    ...
                    <h:outputText id="Codigo" value="#{AlumnoController.alumno.idPersona}" />

                    <h:outputLabel value="Nombres:" for="Nombres"/>
                    <h:outputText id="Nombres" value="#{AlumnoController.alumno.nombres}" />

                    <h:outputLabel value="Apellido Paterno:" for="ApellidoPaterno"/>
                    <h:outputText id="ApellidoPaterno" value="#{AlumnoController.alumno.apellidoPaterno}" />

                    <h:outputLabel value="Apellido Materno:" for="ApellidoMaterno"/>
                    <h:outputText id="ApellidoMaterno" value="#{AlumnoController.alumno.apellidoMaterno}" />
