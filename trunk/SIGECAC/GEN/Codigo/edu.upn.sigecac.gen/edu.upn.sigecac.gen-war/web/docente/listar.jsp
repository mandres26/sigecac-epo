...
<f:view>
    ...
    <BR>
    <div class="centrar">
        <span class="titulo"><h:outputText value="Listar Docentes" /></span>
        <BR>
        <BR>
        <BR>
        ...
        <center>
            ...
            <h:form id="frmListaDocentes">

                <h:panelGrid columns="2" cellpadding="1" cellspacing="10" >
                    <h:commandLink id="btnNuevo" value="Nuevo" accesskey="N" action="#{DocenteController.nuevo}"/>
                </h:panelGrid>

                <h:dataTable id="tblDocentes"
                             value="#{DocenteController.docentes}"
                             var="item"
                             border="1"
                    ...
                    <h:column>
                        <h:commandButton id="btnMostrar" action="mostrar" image="/img/ver.png">
                            <f:setPropertyActionListener target="#{DocenteController.docente}" value="#{item}" />
                        </h:commandButton>
                    </h:column>
                    <h:column>
                    ...
                    <h:column>
                        <h:commandButton id="btnEliminar" action="#{DocenteController.eliminar}" image="/img/eliminar.png">
                            <f:setPropertyActionListener target="#{DocenteController.docente}" value="#{item}" />
                        </h:commandButton>
                    </h:column>
                </h:dataTable>
