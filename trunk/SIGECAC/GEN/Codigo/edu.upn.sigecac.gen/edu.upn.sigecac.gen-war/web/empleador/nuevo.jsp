...
<f:view>
    ...
    <BR>
    <div class="centrar">
        <span class="titulo"><h:outputText value="Registrar Nuevo Empleador" /></span>
        <BR>
        <BR>
        <BR>
            ...
            <h:form id="idFormulario">
                ...
                <h:panelGrid columns="2">
                    ...
                    <h:panelGroup>
                        ...
                        <h:commandButton id="btnGuardar" value="Guardar" accesskey="G" action="#{EmpleadorController.registrar}" />
