...
<f:view>
    ...
    <span class="titulo"><h:outputText style= "margin-left:20px" value="Mostrar Matriz de Alineamiento de Objetivos Educacionales" /></span>
    ...
    <t:div>
        ...
        <h:form>
         ...
         <h:panelGrid columns="2" width="91%">
                <h:commandButton style="font-weight: bold; margin-left:120px; margin-right: auto; background:navy; color:white" id="btnActualizar" value="Actualizar" accesskey="A" action="actualizarMatrizObjetivosEducacionales" />
       ...
       <h:panelGrid columns="2" styleClass="formulario" cellpadding="10" cellspacing="0" border="0">
                ...
                <h:outputText styleClass="outputText" id="Codigo" value="#{MatrizAlineamientoObjetivosEducacionalesController.matrizAlineamientoObjetivosEducacionales.idMatrizAlineamientoObjetivosEducacionales}" />

                <h:outputLabel styleClass="outputLabel" id="lblNombre" value="Nombre: " for="Nombre"/>
                <h:outputText styleClass="outputText" id="Nombre" value="#{MatrizAlineamientoObjetivosEducacionalesController.matrizAlineamientoObjetivosEducacionales.nombre}" />

                <h:outputLabel styleClass="outputLabel" id="lblDescripcion" value="Descripción: " for="Descripcion"/>
                <h:inputTextarea styleClass="inputTextarea" id="Descripcion" value="#{MatrizAlineamientoObjetivosEducacionalesController.matrizAlineamientoObjetivosEducacionales.descripcion}" readonly="true"/>
