...
<f:view>
    ...
    <BR>
    <div class="centrar">
        <span class="titulo"><h:outputText value="Editar Grupo Objetivo" /></span>
        <BR>
        <BR>
        <BR>
        ...
        <center>
            ...
            <h:form id="idFormulario">
                ...
                <h:panelGrid columns="2">
                    ...
                    <h:inputText id="Codigo" value="#{GrupoObjetivoController.grupoObjetivo.idGrupoObjetivo}" readonly="true" />
                    ...
                    <h:panelGroup>
                        ...
                        <h:commandButton id="btnGuardar" value="Guardar" accesskey="G" action="#{GrupoObjetivoController.actualizar}" />
