...
<f:view>
    ...
    <BR>
    <div class="centrar">
        <span class="titulo"><h:outputText value="Listado de Personas" /></span>
        <BR>
        <BR>
        <BR>
        ...
        <center>
            ...
            <h:form id="frmListaAlumnos">
                ...
                <t:panelGrid columns="2" cellpadding="1" cellspacing="10" >
                    <h:commandLink id="btnNuevo" value="Nuevo" accesskey="N" action="#{PersonaController.nuevo}"/>
                </t:panelGrid>

                <h:dataTable id="tblPersonas"
                    ...
                    <h:column>
                        ...
                        <h:outputText value="#{item.xtipo}" />
                    </h:column>
                    <h:column>
                        <h:commandButton id="btnMostrar" action="mostrar" image="/img/ver.png">
                            <f:setPropertyActionListener target="#{PersonaController.persona}" value="#{item}" />
                        </h:commandButton>
                    </h:column>
                    <h:column>
                    ...
                    <h:column>
                        <h:commandButton id="btnEliminar" action="#{PersonaController.eliminar}" image="/img/eliminar.png">
                            <f:setPropertyActionListener target="#{PersonaController.persona}" value="#{item}" />
                        </h:commandButton>
                    </h:column>
                </h:dataTable>
