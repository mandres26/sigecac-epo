<%-- 
    Document   : editarSubArea
    Created on : 12/04/2009, 05:27:49 PM
    Author     : supervisor
--%>
...
<div>
         <h:form prependId="false" id="frmNV" >
              <table cellpadding="0" cellspacing="0" width="100%" >
                  <tr>
                    <td colspan="2" align="center" ><h3 class="title" >Editar SubArea</h3></td>
                </tr>
                <tr><td height="20px" colspan="2" ></td></tr>
                 ...
                 <tr>
                     ...
                     <td><h:selectOneMenu id="cmbArea" value="#{SubArea.subArea.fxIdarea.idArea}" required="true" >
                 ...
                 <tr>
                     <td></td>
                     <td> <h:commandButton id="btnGuardar" action="#{SubArea.editarSubArea}" value="Guardar" />
