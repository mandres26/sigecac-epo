...
<f:view>
    ...
    <br/>
    <div class="centrar"><h1><h:outputText value="Listado de Cuentas de Usuarios" /></h1></div>
    <br/>
    <div class="centrar">
        <h:form id="frmListarUsuario" prependId="false">
            ...
            cellspacing="2" rows="15" align="center">
                ...
                <t:column>
                    <f:facet name="header">
                        <t:outputText value="Activar Cuenta"/>
                    </f:facet>
                    <t:commandLink action="#{UsuarioController.editarcuenta}">
